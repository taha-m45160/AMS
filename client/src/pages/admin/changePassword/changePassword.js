...
export default function ChangePassword() {
  ...
  const handleSubmit = async (ev) => {
    ...
    try{
      ...
      const res = await axios.post("https://academic-management-system.herokuapp.com/admin/changePassword", {ID: state.user.ID, password: password})
      setMsg(res.data)
      setTimeout(() => {
        setMsg('')
    }, 2500)
  ...
  <div>
    <Navbar></Navbar>
    <Homebar></Homebar>
    <div className="col d-flex justify-content-center" id="col8">
        ...
        <div className="col d-flex justify-content-center" id="col9">
        <div className="card text-center m-2" style={{'width':'95%'}}>
          <div className="card-header display-5 fw-bold" style={{'color': 'white', 'backgroundColor':'#0F245A'}}>
            Change Password
          </div>
